...
The analysis focused on prescription data from Octoboer 2022, as this period aligns with the most recent demographic data available from the Octoboer 2022 GP dataset and the Heart Disease Mortality dataset, which spans from January 1 to December 31, 2022. 
