...
joined_data_final_CA %>% 
  ...
  fmt_number(columns = c(paid_quantity, over65_total_death), decimals = 0) %>% #rounding columns to no decimal
  ...
  cols_label( 
    ...
    mean_simd_rank = "Deprivation Score"
  ) %>%
  tab_style(
...
The analysis revealed a strong positive correlation between the elderly population and antihypertensive prescriptions (r = 0.98, p < 0.001), indicating that regions with larger elderly populations tend to have significantly higher prescription volumes. However, the relationship between deprivation and prescriptions showed no meaningful linear correlation (r = -0.004, p = 0.992), suggesting that deprivation levels alone do not predict antihypertensive prescription rates. Similarly, the correlation between deprivation and cardiovascular deaths was negligible (r = -0.003, p = 0.994), indicating no clear association. These findings are counterintuitive, as deprived areas are typically associated with poorer health outcomes and higher cardiovascular mortality. This lack of significant correlation may reflect differences in healthcare access or regional reporting practices, which could underestimate the expected relationships.
