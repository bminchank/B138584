---
title: Trends in the prescribing of antihypertensive medications – can we see higher
...
Cardiovascular disesase(CVD) generally refers to conditions affecting the heart blood or vessels. The causes of CVD isn't just one but there are many risk factors that affect or chance of developing CVD. One of the strongest cuase of CVD is hypertension (high blood pressure) is associated with the strongest evidence for causation and has high prevalence of exposure. CVD's are leading cuase of death globally and in Scotland.
And a big risk factor for hypertension and CVD is old age. Because of this importancce, My project aimed to investigate whether there was a trend in antihypertensive medication prescribing in areas wite more elder demographic. 

older than 65 is set as "elder" in this case because thats how health guidelines usually define it. All the datasets were taken from Public Health Scotland Open Data. Data files used in this can be foudn files and specific data dictionaries here:

https://www.opendata.nhs.scot/

Because the Heart Disease Mortality only had data until year 2022 from 1st jan to dec 31. So I've chose to analyze the prescription data for October of 2022  prescriptions in the community in Scotland. Also because the latest datset for 2022 demographic data was oct 2022 GP data. 
```{r}
...
Pearson analysis was used because it is good tu se for continuous variables (Citation). Correlation tests to see relatinoship.
